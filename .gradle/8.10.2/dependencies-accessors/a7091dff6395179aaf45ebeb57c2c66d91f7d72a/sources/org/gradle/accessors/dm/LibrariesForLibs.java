...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>retrofit2ConverterGson</b> with <b>com.squareup.retrofit2:converter-gson</b> coordinates and
     * with version reference <b>retrofit2</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRetrofit2ConverterGson() {
        return create("retrofit2ConverterGson");
    }
    ...
    public static class ViewLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>model</b> with <b>androidx.lifecycle:lifecycle-viewmodel-ktx</b> coordinates and
        ...
        /**
         * Dependency provider for <b>pager2</b> with <b>androidx.viewpager2:viewpager2</b> coordinates and
         * with version reference <b>viewpager2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPager2() {
            return create("view.pager2");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>daggerHilt</b> with value <b>2.44</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseCrashlyticsBuildtools</b> with value <b>3.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleauth</b> with value <b>21.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>viewmodel</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final DaggersPluginAccessors paccForDaggersPluginAccessors = new DaggersPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.daggers</b>
         */
        public DaggersPluginAccessors getDaggers() {
            return paccForDaggersPluginAccessors;
        }
    ...
    public static class DaggersPluginAccessors extends PluginFactory {
        private final DaggersHiltPluginAccessors paccForDaggersHiltPluginAccessors = new DaggersHiltPluginAccessors(providers, config);

        public DaggersPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.daggers.hilt</b>
         */
        public DaggersHiltPluginAccessors getHilt() {
            return paccForDaggersHiltPluginAccessors;
        }

    }

    public static class DaggersHiltPluginAccessors extends PluginFactory {

        public DaggersHiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>daggers.hilt.plugin</b> with plugin id <b>dagger.hilt.android.plugin</b> and
         * with version reference <b>daggerHilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("daggers.hilt.plugin"); }
